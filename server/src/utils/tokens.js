...
/**
 * The claims carried in an access token. Nothing here is trusted on its own — requireAuth
 * re-reads the user row on every request and compares.
 *
 ...
 * @property {number} tokenVersion Compared against the user row so a password change or
 *   deactivation invalidates it.
 */
