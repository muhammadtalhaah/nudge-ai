 ...
 *
 * Validated with Zod at import time and exported as a frozen, fully typed object. A
 * misconfigured server fails immediately at boot with a readable list of problems, rather
 * than throwing `undefined is not a function` from inside a request three hours later.
 */
